...
function characterMarkup(a,name=''){const x={...DEFAULT_AVATAR,...(a||{})};const skin=x.skinColor||'#d59b76',hair=x.hairColor||'#171717',eyes=x.eyes||'#1d2433';return `<div class="char-code-3d ${characterVariant(name)}" style="--skin:${escapeHtml(skin)};--hair:${escapeHtml(hair)};--eyes:${escapeHtml(eyes)}"><div class="char-aura ${escapeHtml(x.effect||'')}" aria-hidden="true"></div><svg class="char-svg" viewBox="0 0 100 120" role="img" aria-label="Personagem de ${escapeHtml(name||'jogador')}"><ellipse cx="50" cy="112" rx="30" ry="6" class="char-shadow"/><path d="M22 108 Q24 72 50 70 Q76 72 78 108Z" class="char-shirt"/><path d="M31 108 L35 79 L44 82 L40 108Z M69 108 L65 79 L56 82 L60 108Z" class="char-pants"/><circle cx="50" cy="48" r="24" class="char-skin"/><path d="M27 45 Q27 17 50 18 Q74 17 74 45 Q66 31 50 31 Q35 31 27 45Z" class="char-hair"/><circle cx="41" cy="48" r="3.2" class="char-eye"/><circle cx="59" cy="48" r="3.2" class="char-eye"/><path d="M43 61 Q50 65 57 61" class="char-mouth"/><circle cx="50" cy="56" r="4" class="char-nose"/><path d="M42 78 L50 90 L58 78" class="char-shirt-detail"/><circle cx="79" cy="80" r="7" class="char-prop"/></svg><div class="char-item-overlays"></div></div>`;}
