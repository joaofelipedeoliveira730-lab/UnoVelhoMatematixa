...
function startComingSoonMode(room){room.started=false;room.locked=false;io.to(`room:${room.code}`).emit('toast',{type:'info',message:'Esse modo está no próximo pacote. Por enquanto jogue UNO ou Adivinha o Desenho!'});}
